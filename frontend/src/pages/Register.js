  ...
  const handleGoogleRegister = async (credentialResponse) => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        navigate('/Profile-Home', { state: { user: response.data } });
      }, 1000);
    } catch (error) {
    ...
    <>
      <ModalBackground onClick={onClose}>
        <ModalContent onClick={e => e.stopPropagation()}>
          ...
          <Title>Welcome to TaskSphere</Title>
          <Subtitle>Organize Your Tasks</Subtitle>
          ...
          />
          <Text>
            By continuing, you agree to TaskSphere's <Link href="/terms">Terms of Service</Link> and acknowledge you've read our <Link href="/privacy">Privacy Policy</Link>. <Link href="/notice">Notice at collection</Link>.
          </Text>
          <Text>
            Already a member? <Link onClick={handleLoginClick}>Log in</Link>
          </Text>
        </ModalContent>
      </ModalBackground>
